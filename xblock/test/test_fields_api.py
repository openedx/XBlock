...
class StaticFDDefaultTestCases(UniversalTestCases, DefaultValueProperties):
...
class ComputedFDDefaultTestCases(UniversalTestCases, DefaultValueProperties):
...
class TestImmutableWithStaticFDDefault(ImmutableTestCases, StaticFDDefaultTestCases):
    __test__ = False
...
class TestImmutableWithComputedFDDefault(ImmutableTestCases, ComputedFDDefaultTestCases):
    __test__ = False
...
class TestMutableWithStaticFDDefault(MutableTestCases, StaticFDDefaultTestCases, DefaultValueMutationProperties):
    __test__ = False
...
class TestMutableWithComputedFDDefault(MutableTestCases, ComputedFDDefaultTestCases, DefaultValueMutationProperties):
    __test__ = False
...
class TestImmutableWithCallableDefault(TestImmutableWithStaticFDDefault):
    __test__ = False
...
class TestMutableWithCallableDefault(TestImmutableWithStaticFDDefault):
    __test__ = False
...
for operation_backend in (BlockFirstOperations, FieldFirstOperations):
    for persist_default in (False, True):
        for noop_prefix in (None, GetNoopPrefix, GetSaveNoopPrefix, SaveNoopPrefix):
            for base_test_case in (TestImmutableWithComputedFDDefault, TestImmutableWithInitialValue,
                                   TestImmutableWithStaticFDDefault, TestMutableWithComputedFDDefault,
                                   TestMutableWithInitialValue, TestMutableWithStaticFDDefault,
