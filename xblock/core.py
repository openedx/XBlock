...
class XBlock(Plugin):
    ...
    def _get_fields_to_save(self):
        ...
        for field_name, field in self.fields.items():
            ...
            if field in self._dirty_fields and field._is_dirty(self):
                fields_to_save[field_name] = field.to_json(self._field_data_cache[field_name])
            elif field._persist_default and self._field_data.is_writable(self, field_name) \
                    and not field.is_set_on(self):
