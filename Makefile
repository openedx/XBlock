...
upgrade: ## update the pip requirements files to use the latest releases satisfying our constraints
	...
	pip-compile --upgrade --rebuild -o requirements/django.txt requirements/django.in
	...
	pip-compile --upgrade --rebuild -o requirements/travis.txt requirements/travis.in
